...
hl.bind("CTRL + SUPER + Delete", hl.dsp.exec_cmd("noctalia msg panel-toggle session"))
...
-- Shell Management
hl.bind("CTRL + SUPER + ALT + R", hl.dsp.exec_cmd("pkill noctalia; noctalia"), { desc = "Restart shell" })
