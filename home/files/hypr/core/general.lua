...
-- Load dynamic-cursors plugin (loaded via NixOS / Home-Manager if available)
-- pcall(hl.plugin.load, "/var/cache/hyprpm/cleboost/dynamic-cursors/dynamic-cursors.so")
