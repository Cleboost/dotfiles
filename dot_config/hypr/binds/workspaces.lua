...
hl.bind("Ctrl + SUPER + Right", hl.dsp.workspace.focus("r+1"))
hl.bind("Ctrl + SUPER + Left", hl.dsp.workspace.focus("r-1"))
hl.bind("SUPER + Page_Down", hl.dsp.workspace.focus("+1"))
hl.bind("SUPER + Page_Up", hl.dsp.workspace.focus("-1"))
hl.bind("SUPER + mouse_up", hl.dsp.workspace.focus("r+1"))
hl.bind("SUPER + mouse_down", hl.dsp.workspace.focus("r-1"))
hl.bind("Ctrl + SUPER + mouse_up", hl.dsp.workspace.focus("r+1"))
hl.bind("Ctrl + SUPER + mouse_down", hl.dsp.workspace.focus("r-1"))
...
hl.bind("Ctrl + SUPER + BracketLeft", hl.dsp.workspace.focus("-1"))
hl.bind("Ctrl + SUPER + BracketRight", hl.dsp.workspace.focus("+1"))
